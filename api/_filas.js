...
//
// REGRA: só role='vendedor' entra sozinho, e apenas nas filas ativas que não
// são a de segurança. Gestor/admin NÃO são inscritos automaticamente — receber
...
export async function inscreverNasFilas(admin, userId, role) {
